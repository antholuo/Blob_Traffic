...
def agent(state_shape, action_shape):
    ...
    model.add(keras.layers.Dense(env.grid_view.grid.size, input_shape=state_shape, activation='relu', kernel_initializer=init))
    model.add(keras.layers.Dense(env.grid_view.grid.size, activation='relu', kernel_initializer=init))
